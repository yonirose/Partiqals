...
class ErrorHandler():
    def __init__(self, log_name='analyze_err.log', reset_log=False):
    ...
    def parse_errlog(self):
        ...
        for log_file in os.listdir(self.base_path):
            if log_file.split('_')[-1] == 'scrapy.log':
                log_name = log_file.split('.')[0]
                with open(os.path.join(self.base_path, log_name + '_L1.log'), 'w') as errf:
                    with open(os.path.join(self.base_path, log_file), 'r') as f:
                ...
                # Save statistics
                with open(os.path.join(self.base_path, log_name + '_L3.log'), 'w') as fr:
                    with open(os.path.join(self.base_path, log_name + '_L2.log'), 'w') as f:
